...
INSERT INTO parts_classifications values(0,'-------'    ,'None (typeabbreviation)','t','t');
...
ALTER TABLE parts ADD CONSTRAINT parts_classification_id_fkey FOREIGN KEY (classification_id) REFERENCES parts_classifications(id);
